...
lines.append('folder: "02_Ai/AI_adscrm/AIads/reports/"')
...
lines.append("## 関連リンク")
lines.append("")
lines.append("- [AIads_ope.md](file:///Users/masaaki_nagasawa/Documents/Obsidian%20Vault/02_Ai/AI_adscrm/AIads/AIads_ope.md)")
