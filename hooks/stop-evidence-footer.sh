...
# --- ユーザーへ質問を投げる前置きメッセージは対象外(AskUserQuestion 直前等) ---
#     結論でなく問いかけのターンにフッターを要求しない(誤検知回避・2026-07-02)
tail300 = last_text[-300:]
if re.search(r"聞きます|質問します|お聞きします|教えてください|選んでください|どれ(に|で)?しますか|どちら|いずれ|回答をください|お答えください", tail300):
    sys.exit(0)
