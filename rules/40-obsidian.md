...
- 構成要素: 12 skills (workflow 層) + 5 slash commands + 5 kepano skills (primitive 層) + 2 agents + 6 hooks + 1 MCP server (mcpvault)
...
| `obsidian-bases` | `.base` ファイル（YAML, views/filters/formulas） | 単独利用可（既存運用と非衝突） |
