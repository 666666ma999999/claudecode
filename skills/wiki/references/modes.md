...
```
vault/
├── References/raw/              # crawl exports, analytics, scraped pages, GSC data
├── wiki/
...
```
vault/
├── References/raw/              # README, git log exports, code dumps, issue exports
├── wiki/
...
```
vault/
├── References/raw/              # meeting transcripts, Slack exports, docs, emails
├── wiki/
...
```
vault/
├── References/raw/              # journal entries, articles, podcast notes, voice transcripts
├── wiki/
...
```
vault/
├── References/raw/              # PDFs, web clips, data files, raw notes
├── wiki/
...
```
vault/
├── References/raw/              # chapter notes, highlights, exercises
├── wiki/
