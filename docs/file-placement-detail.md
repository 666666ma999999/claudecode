...
> 67 種の完全な配置表・備考・命名規約・根拠・適用順序の SSoT。
...
**位置づけ**: Claude ↔ Obsidian 連携プロジェクトでの **ファイル種別 67 種の配置 SSoT** (Active・Phase 2+5 hook 連動)
**関連 rules**:
...
- H 5 / I 5 / J 4 / K 4 / L 3 / M 6 (2026-05-25 追記) / **N 8 命名規約 (2026-05-27 追記・H-7 連動 N-8 追加)**
- **合計 67 種**
