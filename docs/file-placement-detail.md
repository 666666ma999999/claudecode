...
> 由来: 2026-07-10 仕事フォルダ4領域監査（12エージェント・提案9/保留45・Codexレビュー済）。監査台帳・復元ログ = `~/.claude/tasks/workfolder-structure-audit/`。Desktop 側の1枚版 = `~/Desktop/_placement-rules.md`（本節の要約+ポインタ）。vault サマリ = `wiki/meta/file-placement-rules.md` 同名節。
